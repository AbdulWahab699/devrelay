...
const styles: Record<string, React.CSSProperties> = {
  ...
  bgArc1: {
    ...
    width: "140vw", height: "140vw", border: "1px solid rgba(0,245,212,0.04)", borderRadius: "50%", pointerEvents: "none",
  },
  bgArc2: {
    position: "absolute", bottom: "-30%", left: "50%", transform: "translateX(-50%)",
    width: "180vw", height: "180vw", border: "1px solid rgba(0,245,212,0.03)", borderRadius: "50%", pointerEvents: "none",
  },
  bgArc3: {
    position: "absolute", bottom: "-40%", left: "50%", transform: "translateX(-50%)",
    width: "220vw", height: "220vw", border: "1px solid rgba(0,245,212,0.02)", borderRadius: "50%", pointerEvents: "none",
  },
  card: {
    display: "flex", width: "100%", maxWidth: "900px", minHeight: "480px",
    background: "rgba(11, 43, 38, 0.45)", backdropFilter: "blur(48px)", WebkitBackdropFilter: "blur(48px)",
    border: "1px solid rgba(255,255,255,0.10)", borderRadius: "32px", overflow: "hidden",
  ...
  leftPanel: {
    flex: 1, padding: "48px 40px", display: "flex", flexDirection: "column", gap: "24px",
    background: "rgba(5, 20, 18, 0.3)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)",
    animation: "staggerFadeUp 0.7s cubic-bezier(0.16, 1, 0.3, 1) forwards",
    animationFillMode: "both", animationDelay: "0.2s",
  },
  logo: { display: "flex", alignItems: "center", gap: "8px" },
  logoText: { fontSize: "16px", fontWeight: 600, color: "#E2F1E7", letterSpacing: "-0.01em" },
  taglineWrap: { flex: 1, display: "flex", alignItems: "center" },
  tagline: { fontSize: "28px", fontWeight: 600, color: "#E2F1E7", lineHeight: 1.3, letterSpacing: "-0.02em", minHeight: "72px" },
  cursor: {
    display: "inline-block", width: "3px", height: "26px", backgroundColor: "#00F5D4",
    marginLeft: "4px", verticalAlign: "text-bottom", animation: "cursorBlink 1s step-end infinite",
  },
  leftSub: { fontSize: "14px", color: "#8EB69B", lineHeight: 1.7 },
  dots: { display: "flex", gap: "8px", alignItems: "center" },
  dot: { width: "6px", height: "6px", borderRadius: "50%" },
  divider: {
    width: "1px", background: "rgba(142, 182, 155, 0.12)", flexShrink: 0, transformOrigin: "top",
    animation: "dividerDraw 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards",
    animationFillMode: "both", animationDelay: "0.35s",
  },
  rightPanel: {
    flex: 1, padding: "48px 40px", display: "flex", flexDirection: "column", justifyContent: "center", gap: "28px",
    animation: "staggerFadeUp 0.7s cubic-bezier(0.16, 1, 0.3, 1) forwards",
    animationFillMode: "both", animationDelay: "0.5s",
  },
  heading: { fontSize: "24px", fontWeight: 600, color: "#E2F1E7", letterSpacing: "-0.02em", marginBottom: "8px" },
  subheading: { fontSize: "14px", color: "#8EB69B", lineHeight: 1.6 },
  errorBox: {
    display: "flex", alignItems: "center", gap: "8px", padding: "12px 16px",
    background: "rgba(255, 107, 107, 0.08)", border: "1px solid rgba(255, 107, 107, 0.2)",
    borderRadius: "10px", fontSize: "13px", color: "#FF6B6B",
  },
  githubBtn: {
    display: "flex", alignItems: "center", justifyContent: "center", gap: "10px",
    width: "100%", height: "44px", background: "rgba(11, 43, 38, 0.4)",
    border: "1px solid rgba(142, 182, 155, 0.2)", borderRadius: "10px",
    color: "#E2F1E7", fontSize: "14px", fontWeight: 500, cursor: "pointer",
    transition: "border-color 150ms ease, background 150ms ease", fontFamily: "inherit",
  },
  spinner: {
    width: "16px", height: "16px", border: "2px solid rgba(142,182,155,0.2)",
    borderTopColor: "#00F5D4", borderRadius: "50%", animation: "spin 0.7s linear infinite",
  },
  legal: { fontSize: "12px", color: "#235347", textAlign: "center", lineHeight: 1.6 },
  legalLink: { color: "#8EB69B", cursor: "pointer", textDecoration: "underline" },
}